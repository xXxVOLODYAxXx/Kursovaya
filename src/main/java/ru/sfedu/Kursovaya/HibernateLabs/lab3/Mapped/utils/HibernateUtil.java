...
import ru.sfedu.Kursovaya.HibernateLabs.lab3.Mapped.models.MappedHibernatePlanet;
...
public class HibernateUtil {
    ...
    private static void addEntities(MetadataSources metadataSources){
        metadataSources.addAnnotatedClass(MappedHibernatePlanet.class);
        metadataSources.addAnnotatedClass(MappedHibernatePlayerPlanet.class);
    }
