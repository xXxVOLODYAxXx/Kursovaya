...
import ru.sfedu.Kursovaya.HibernateLabs.lab3.SingleTable.models.SingleHibernatePlanet;
...
public class HibernateUtil {
    ...
    private static void addEntities(MetadataSources metadataSources){
        metadataSources.addAnnotatedClass(SingleHibernatePlanet.class);
        metadataSources.addAnnotatedClass(SingleHibernatePlayerPlanet.class);
    }
