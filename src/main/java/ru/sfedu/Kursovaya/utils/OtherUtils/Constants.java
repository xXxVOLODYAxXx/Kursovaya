...
public class Constants {
    ...
    public static final String POST_SCHEMA_NAME="Get schema name: {}";
    public static final String SCHEMA_DETAILS="Get details: {}";
    public static final String TABLE_NAME="Get table name: {}";
    public static final String SCHEMA_SIZE="Get schema size: {}";
    ...
    public static final String SCHEMA_NAME = "SELECT TABLE_SCHEMA FROM information_schema.tables";
