...
public class Constants {
    ...
    public static final short NUMBER_SIX_WITH_EXTRA_DIP=6+1;
    public static final String NUMBER_SEVEN="seven";
    public static final String KEY="key";
    public static final int TWO_NUMBER_FORTY_FIVES_ONE_WITH_CHEESE=45+1+45;
    public static final long LARGE_SODA=10000;
}
